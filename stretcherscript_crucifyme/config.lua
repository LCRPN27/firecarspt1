...
Config.Hash = {
	{hash = "fordambo", detection = 4.8, depth = -3.0, height = 0.45},
	{hash = "freightliner", detection = 4.8, depth = -1.5, height = 0.10},
	{hash = "fhauler", detection = 5.8, depth = -3.0, height = 0.10},
